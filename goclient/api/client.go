...
// APIClient manages communication with the Container Security API API vv1.3
...
type APIClient struct {
	...
	ActivationApi *ActivationApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ActivationApi = (*ActivationApiService)(&c.common)
