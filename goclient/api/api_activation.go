...
type ActivationApiService service
/*
ActivationApiService Sensor Activation API
Returns customerId, activationId, platformUrl which is required to activate CS sensor.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return Activation
*/
func (a *ActivationApiService) GetSensorActivationKeys(ctx context.Context) (Activation, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/activationkey"
