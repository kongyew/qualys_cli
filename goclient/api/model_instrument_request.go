...
type InstrumentRequest struct {
	...
	PullRegistryUuid string `json:"pullRegistryUuid,omitempty"`
	PullRepository string `json:"pullRepository,omitempty"`
	PullTag string `json:"pullTag,omitempty"`
	PushRepository string `json:"pushRepository,omitempty"`
	PushTag string `json:"pushTag,omitempty"`
}
