...
type RegistryRequest struct {
	Aws *AwsConnector `json:"aws,omitempty"`
	Credential *RegistryRequestCredential `json:"credential,omitempty"`
	CredentialType string `json:"credentialType,omitempty"`
	DockerHubOrgName string `json:"dockerHubOrgName,omitempty"`
